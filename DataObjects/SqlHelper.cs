...
namespace DataObjects
{
    ...
    public sealed class GetConnection
    {
        ...
        string sqldb = String.Format("server={0};user id={1}; password={2}; database={3}; pooling=false", "SWEENIL-PC\\SQLEXPRESS", "admin", "admin", "ASPNETDB");
        ...
        private void MakeConnection()
        {
            try
            {
                objCon.ConnectionString = sqldb;
                objCon.Open();
            }
            //Catching Sql error
            catch (SqlException oex)
            {
                //SqlError oe = new SqlError();
    ...
    public sealed class SqlHelper
    {
       public static string GetConnectionString()
        ...
        public static SqlParameter GetSqlParam(string paramName, object paramValue, SqlDbType paramDBType, ParameterDirection paramDirection)
        {
